...
public class JWTUtill {
    ...
    private Date generateExpirationDate() {
        return new Date(System.currentTimeMillis() + jwtConfigProperties.getExpiration().longValue() * 1000);
    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails, Map<String,Object> result, String url) {
...
//            result.put("","用户名错误。");
//        }
        if(isTokenExpired(token) && url.contains("/api/web/")){ //app不验证过期
            result.put("expired",true);//token过期
        }
//        if(isCreatedBeforeLastPasswordReset(created, user.getLastPdRestTime())){
//            result.put("pdExpired",true);//密码过期
//        }
//        return (
//                username.equals(user.getAccount())
//                        && !isTokenExpired(token)
//                        && !isCreatedBeforeLastPasswordReset(created, user.getLastPdRestTime()));
        return (
